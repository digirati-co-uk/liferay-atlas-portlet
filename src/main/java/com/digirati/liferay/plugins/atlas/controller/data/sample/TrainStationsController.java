...
public class TrainStationsController {
    ...
    @ResponseBody
    @RequestMapping(method = RequestMethod.GET, value = "/data/trainstations")
    public List<Marker> getUndergroundStations() throws IOException {

        Icon icon = new Icon("/atlas-portlet/images/train.png", 16, 34);

        List<Marker> mapMarkers = new ArrayList<Marker>();
        InputStream inputStream = getClass().getResourceAsStream("/data/train-stations.csv");
